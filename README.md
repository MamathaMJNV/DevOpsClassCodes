...
designed. Please note this example uses and requires Java 8 to work. updated the line for git poll scm jenkins to pick. added one more line for email notification. added one line to pick by jenkins

demonstrating webhook
